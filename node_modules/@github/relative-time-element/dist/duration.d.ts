...
export declare function roundToSingleUnit(duration: Duration): Duration;
export declare function getRelativeTimeUnit(duration: Duration): [number, Intl.RelativeTimeFormatUnit];
export {};
